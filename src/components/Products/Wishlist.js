...
function Wishlist() {
  const { wishlist, removeFromWishlist, clearWishlist, updateWishlistItemQuantity } = useContext(WishlistContext);
                      ...
                      <Card.Body>
                        ...
                        <div>
                          <Button 
                            ...
                            onClick={() => updateWishlistItemQuantity(item.id, Math.max(1, item.quantity - 1))}
                          >
                            -
                          </Button>
                          <FormControl 
                          ...
                          <Button 
                            variant="outline-secondary" 
                            onClick={() => updateWishlistItemQuantity(item.id, item.quantity + 1)}
                          >
                            +
                          </Button>
                        </div>
